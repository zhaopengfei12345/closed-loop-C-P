...
python scripts/train_forecaster.py \
  ...
  --output-dir results/lstm_1h_forecast
```

The forecaster writes `results/lstm_1h_forecast/test_predictions.csv`, which is the input to the dispatch scripts.

Evaluate the predict-then-optimize baseline:

```bash
python scripts/run_baseline_dispatch.py \
  --prediction-path results/lstm_1h_forecast/test_predictions.csv \
